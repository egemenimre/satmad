...
It contains an Astropy :class:`astropy:astropy.coordinates.SkyCoord` object to keep the discrete points of the
trajectory. However, it can output the coordinates for any requested time within the time bounds of the original
:class:`astropy:astropy.coordinates.SkyCoord` trajectory object. This enables many other functionalities
