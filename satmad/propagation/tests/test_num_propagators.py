...
from satmad.coordinates.frames import MoonCRS, init_rvt
...
def rv_init_moon_crs():
    ...
    rv_init = init_rvt(MoonCRS, time, r_moon_crs.with_differentials(v_moon_crs))
...
def rv_init_leo_gcrs():
    ...
    rv_init = init_rvt(GCRS, time, r_gcrs.with_differentials(v_gcrs))
    return rv_init
